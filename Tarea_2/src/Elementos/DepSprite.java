...
public class DepSprite extends JPanel {
    /**
     * definimos nuestras coordenadas int x e int y para crear el boton que se encarga de administrar sprite en el
    ...
    private int cant=24;
    /**
     * el metodo constructor crea los objetos visibles dentro del expendedor que representan a las sprites
     */
    public DepSprite(){
